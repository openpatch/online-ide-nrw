...
import { NRWStackClass } from "../../runtimelibrary/nrw/NRWStack.js";
import { NRWBinaryTreeClass } from "../../runtimelibrary/nrw/NRWBinaryTree.js";
import { NRWComparableContentClass } from "../../runtimelibrary/nrw/NRWComparableContent.js";
import { NRWBinarySearchTreeClass } from "../../runtimelibrary/nrw/NRWBinarySearchTree.js";
import { NRWVertexClass } from "../../runtimelibrary/nrw/NRWVertex.js";
import { NRWEdgeClass } from "../../runtimelibrary/nrw/NRWEdge.js";
import { NRWGraphClass } from "../../runtimelibrary/nrw/NRWGraph.js";
...
export class BaseModule extends Module {
    constructor(main: MainBase) {
        ...
        this.typeStore.addType(new NRWStackClass(this));
        this.typeStore.addType(new NRWQueueClass(this));
        this.typeStore.addType(new NRWComparableContentClass(this));
        this.typeStore.addType(new NRWBinaryTreeClass(this));
        this.typeStore.addType(new NRWBinarySearchTreeClass(this));
        this.typeStore.addType(new NRWVertexClass(this));
        this.typeStore.addType(new NRWEdgeClass(this));
        this.typeStore.addType(new NRWGraphClass(this));
